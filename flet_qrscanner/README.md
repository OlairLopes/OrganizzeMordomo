...
flet-qrscanner [Flet](https://flet.dev) extension.
...
Add `flet-qrscanner` dependency to the `pyproject.toml` of your Flet project:

* **From Git**

```toml
dependencies = [
  "flet-qrscanner @ git+https://github.com/MY_GITHUB_ACCOUNT/flet-qrscanner",
  "flet>=0.86.4",
]
```
...
Detailed documentation for this package can be found [here](https://MY_GITHUB_ACCOUNT.github.io/flet-qrscanner/).
